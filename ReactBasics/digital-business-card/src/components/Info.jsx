...
export default function Info() {
    ...
    return (
        <div className="info">
            <img src={businesscard} alt="businesscard_logo" className="info--img" />
            <h1 className="info--name">s7acktrac3</h1>
            <h3 className="info--title">Senior Security Engineer</h3>
            <p className="info--site">https://s7acktrac3.co </p>
            <div className="info--buttons">

                <button className="info--email-button"><svg width="17" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <button className="info--linkedin-button"> <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
